// -------------------------------------------------------------
// 
// File Name: hdlsrc\fft_st\Radix2ButterflyG.v
...
module Radix2ButterflyG
  ...
  ComplexMultiply_block   u_complexMultiply   (.clk(clk),
                                               .enb(enb),
  ...
  // Radix2ButterflyG
  always @(posedge clk)
    begin : Radix2ButterflyG_1_process
      if (reset == 1'b1) begin
  ...
  always @(Radix2ButterflyG_stageOut_reg, Radix2ButterflyG_din1_pipe1,
       ...
       stageIn_4, procEnb, x_u_in, multRes1, multRes2, extended_dvld) begin
    ...
    Radix2ButterflyG_stageOut_reg_next = stageIn_4 + 3'b001;
    ...
    stageOut_4_1 = Radix2ButterflyG_stageOut_reg;
  ...
  assign stageOut_4 = stageOut_4_1;
