// -------------------------------------------------------------
// 
// File Name: hdlsrc\fft_st\Radix2ButterflyG_block.v
...
// -------------------------------------------------------------
// 
// Module: Radix2ButterflyG_block
// Source Path: fft_st/fft_st/FFT HDL Optimized/RADIX2FFT_KernelG/Radix2ButterflyG
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Radix2ButterflyG_block
  ...
  ComplexMultiply_block1   u_complexMultiply   (.clk(clk),
                                                .enb(enb),
  ...
  always @(Radix2ButterflyG_stageOut_reg, Radix2ButterflyG_din1_pipe1,
       ...
       stageIn_5, procEnb, x_u_in, multRes1, multRes2, extended_dvld) begin
    ...
    Radix2ButterflyG_stageOut_reg_next = stageIn_5 + 3'b001;
    ...
    Radix2ButterflyG_realInVld_pipe1_next = procEnb;
    stageOut_5_1 = Radix2ButterflyG_stageOut_reg;
  ...
  assign stageOut_5 = stageOut_5_1;
...
endmodule  // Radix2ButterflyG_block
